...
use Timdesm\PterodactylPhpApi\Exceptions\TimeoutException;
...
class Http
{
    ...
    protected function transform($response)
    {
        ...
        $class = class_exists('\\Timdesm\\PterodactylPhpApi\\Resources\\'.$object) ?
            '\\Timdesm\\PterodactylPhpApi\\Resources\\'.$object :
            '\\Timdesm\\PterodactylPhpApi\\Resources\\'.$object;
